    ...
    public class CrossPlataformUtil : ICrossPlataformUtil
    {
        ...
        public string GetIdentifier()
        {
            ...
            try
            {
                ...
                if (strDeviceId == null)
                    strDeviceId = Guid.NewGuid().ToString();
        ...
        public void TrackKeepAlive(Boolean isKeepAlive)
        {
            ...
            try
            {
                ...
                Int32 tempoKeepAlive = conf.TempoKeepAlive;

                Int64 totalMilliseconds = (long)TimeSpan
                    .FromSeconds(tempoKeepAlive)
                    .TotalSeconds;
                Context contexto = Android.App.Application.Context;
        ...
        public void OpenStreet(String paramLatitude, String paramLongitude)
        {
            try
            {
                ...
                if (mapIntent.ResolveActivity(Android.App.Application.Context.PackageManager) != null)
                {
            ...
            {
                // If StreetView is not installed, open it in Google Play:
