...
namespace family.Droid
{
    ...
    public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity, ActivityCompat.IOnRequestPermissionsResultCallback
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            OneSignal.Current.StartInit("2737ba84-8257-406b-890e-5f9192840e6f")
                  .EndInit();
            ...
            try
            {
                ...
                //            .SetApplicationId("br.com.khronosnet")
                //            .SetDatabaseUrl("https://ssx-khronos.firebaseio.com")
                //            .SetGcmSenderId("107839767590")
                //            .Build();
            ...
            LoadApplication(new App(true, "atm"));
